...
<fieldset> 
    <legend class="prod"><strong>Finalizar la Compra</strong> 
       <a href="#" onClick="javascript:window.open('https://www.paypal.com/signin?returnUri=https%3A%2F%2Fwww.paypal.com%2Fcgi-bin%2Fwebscr%3fcmd%3d','olcwhatispaypal','toolbar=no, location=no, directories=no, status=no, menubar=no, scrollbars=yes, resizable=no, width=400, height=350');">
           <img src="https://www.paypal.com/en_US/i/bnr/horizontal_solution_PP.gif" alt="Solution Graphics" style="border: 0;">
       </a>
    </legend>
    ...
    <table style="text-align: center; background-color: #EABB5D" width="50%" cellpadding="3" cellspacing="0" style=" border-color:#000000; border-style:solid; border-width:1px;"> 
    <tr> 
        <td style="align-items: left;" valign="top"><span class="prod"><strong>Detalle de los Productos Seleccionados</strong>:</span><br> 
